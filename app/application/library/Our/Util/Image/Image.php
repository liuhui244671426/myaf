 ...
 * @url: http://www.lai18.com/content/369393.html
 *
 */
...
class Image
{
    ...
    {
        $spath = $path == "." ? rtrim($this->_path, "/") . "/" : $path . '/';
    ...
    private function createNewImage($newImg, $newName, $imgInfo)
    {
        ...
        switch ($imgInfo["type"]) {
            case 1:       //gif
                $result = imageGIF($newImg, $this->_path . $newName);
                break;
            case 2:       //jpg
                $result = imageJPEG($newImg, $this->_path . $newName);
                break;
            case 3:       //png
                $result = imagePng($newImg, $this->_path . $newName);
                break;
        }
        imagedestroy($newImg);
        return $newName;
