$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', '/statics/charisma/components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', '/statics/charisma/css/bootstrap-' + themeName + '.min.css');
        }
    ...
    $('.myModal').click(function(){
        ...
        $('#myModal').modal('show');
        //delete
        $('#del-y').click(function(e){
            var url = '/admin/articles/del', data = {'id':id};
            //data = $(data).serialize();
            console.log(data);
            postAjax(url, data, function(d){

                console.log('sccuessed!', d);
            });
        });
    });

    KindEditor.ready(function(K) {
        window.editor = K.create('#kedit', {
            height: '300px',
            //--upload conf start
            uploadJson : '/admin/articles/upload',
